...
Проект направлен на сбор данных с объявлениями о продаже квартир (по заданной ссылке "url_c" с предустановленными фильтрами с сайта циан), предобработку данных и загрузку в БД (используется диалект PostgreSQL)
